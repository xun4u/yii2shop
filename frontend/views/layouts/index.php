        ...
        <div class="topnav_right fr">
            <ul>
                ...
                if(Yii::$app->user->isGuest){?>
                    <li>您好，欢迎来到京西！[<?=Html::a('登录',['member/login'])?>] [<?=Html::a('注册',['member/register'])?>] </li>
                    <li class="line">|</li>
                    <li>客户服务</li>
                <?php }else{ ?>
                    <li><?=Yii::$app->user->identity->username?>，欢迎来到京西！[<?=Html::a('注销',['member/logout'])?>]  </li>
                    <li class="line">|</li>
                    <li>我的订单</li>
...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><?=Html::a(Html::img('@web/images/logo.png'),['index/index'])?><!--<a href="index.html"><img src="images/logo.png" alt="京西商城"></a>--></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
            <div class="search_form">
                <div class="form_left fl"></div>
                <form action="<?=\yii\helpers\Url::to(['index/search'])?>" name="serarch" method="get" class="fl">
            ...
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        <?php
                        if(Yii::$app->user->isGuest){
                            echo '您好，请'.Html::a('登录',['member/login']);
                        }else{
                            echo "您好,用户".Yii::$app->user->identity->username;
                        }
