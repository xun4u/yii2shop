...
<div class="header w990 bc mt15">
    <div class="logo w990">
        <h2 class="fl"><?=\yii\helpers\Html::a(\yii\helpers\Html::img('@web/images/logo.png'),['index/index'])?></a></h2>
...
<div class="success w990 bc mt15">
    ...
    <div class="success_bd">
        ...
        <p class="message">完成支付后，你可以 <?=\yii\helpers\Html::a('查看订单状态',['index/order-list'])?>  <a href="">继续购物</a> <a href="">问题反馈</a></p>
    </div>
</div>
<!-- 主体部分 end -->
