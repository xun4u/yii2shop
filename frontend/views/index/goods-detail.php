    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$model->logo,['class'=>'jqzoom','rel'=>'gall'])?>
<!--                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   -->
                        <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                    <?=\yii\helpers\Html::img('http://admin.yii2shop.com'.$model->logo)?>
<!--                        <img src="images/preview_m1.jpg" alt="" />             -->
                    <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['index/add-to-cart'])?>" method="post" class="choose">
                    <ul>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$model->sn?></li>
                            <li><span>品牌：</span><?=$model->goodsCategory->name?></li>
